...
event = {'Records': [{'eventID': '9f8e33e18130c92a1ece87041211a588', 'eventName': 'MODIFY', 'eventVersion': '1.1', 'eventSource': 'aws:dynamodb', 'awsRegion': 'us-east-2', 'dynamodb': {'ApproximateCreationDateTime': 1606167468.0, 'Keys': {'id': {'S': '139'}}, 'NewImage': {'date': {'S': '05/18/2008'}, 'venue': {'S': 'Rajiv Gandhi International Stadium, Uppal'}, 'win_by_wickets': {'N': '0'}, 'city': {'S': 'Hyderabad'}, 'team1': {'S': 'Mumbai Indians'}, 'team2': {'S': 'Deccan Chargers'}, 'dl_applied': {'N': '0'}, 'result': {'S': 'normal'}, 'player_of_match': {'S': 'DJ Bravo'}, 'winner': {'S': 'Mumbai Indians'}, 'umpire1': {'S': 'BR Doctrove'}, 'season': {'N': '2008'}, 'toss_winner': {'S': 'Deccan Chargers'}, 'umpire3': {'S': ''}, 'id': {'S': '139'}, 'umpire2': {'S': 'DJ Harper'}, 'toss_decision': {'S': 'field'}, 'win_by_runs': {'N': '35'}}, 'OldImage': {'date': {'S': '05/18/2008'}, 'venue': {'S': 'Rajiv Gandhi International Stadium, Uppal'}, 'win_by_wickets': {'N': '0'}, 'city': {'S': 'Hyderabad'}, 'team1': {'S': 'Mumbai Indians'}, 'team2': {'S': 'Deccan Chargers'}, 'dl_applied': {'N': '0'}, 'result': {'S': 'normal'}, 'player_of_match': {'S': 'DJ Bravo'}, 'winner': {'S': 'Mumbai Indians'}, 'umpire1': {'S': 'BR Doctrove'}, 'season': {'N': '2008'}, 'toss_winner': {'S': 'Deccan Chargers'}, 'umpire3': {'S': ''}, 'id': {'S': '139'}, 'umpire2': {'S': 'DJ Harper'}, 'toss_decision': {'S': 'field'}, 'win_by_runs': {'N': '25'}}, 'SequenceNumber': '89234200000000002923934217', 'SizeBytes': 615, 'StreamViewType': 'NEW_AND_OLD_IMAGES'}, 'eventSourceARN': 'arn:aws:dynamodb:us-east-2:615533125910:table/Matches/stream/2020-11-23T20:55:49.105'}]}
